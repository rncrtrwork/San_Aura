...
- [ ] Add base UI theme (colors/typography) matching approved admin design (dark green sidebar, gold accent, ivory background)
...
- [ ] Build admin sidebar nav (Overview/Reservations/Calendar/Events/Stays & Rates/Resort Map/Gallery/FAQ & Rules/Content/Settings) with active-state highlighting
...
- [ ] Build Stays & Rates page shell with tabs (Stay Types/Rate Plans/Availability Rules/Add-ons)
