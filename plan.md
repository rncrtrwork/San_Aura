...
- [x] Unit-test `resolveBillingMode()` against all four membership tiers and stated exceptions
...
- [x] Follow up with client to confirm the still-unspecified weekly electric rate before finalizing `resolveBillingMode()` and the fourth membership tier amount ("I feel like I'm forgetting one")
